...
public class AddSupplierActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getString(R.string.title_add_supplier));
    ...
    public boolean onOptionsItemSelected(final MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_done:
                ...
                if(TextUtils.isEmpty(supplierName.getText().toString())){

                    supplierName.setError("required");
                    return true;
                }
                if(TextUtils.isEmpty(supplierPhone.getText().toString())){

                    supplierPhone.setError("required");
                    return true;
                }

                Supplier supplier = new Supplier();
                supplier.setName(supplierName.getText().toString());
                supplier.setPhoneNumber(supplierPhone.getText().toString());
                supplier.setAddress(supplierAddress.getText().toString());
                dbManager.addSupplier(supplier);
                ToastUtils.showShort("Supplier Added");
                return true;
