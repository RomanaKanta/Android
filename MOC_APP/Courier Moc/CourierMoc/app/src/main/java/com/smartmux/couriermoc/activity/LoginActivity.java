...
public class LoginActivity extends AppCompatActivity {
    ...
    public void login() {
        ...
        if (infoMatching(email, password)) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_SIGNUP) {
            if (resultCode == RESULT_OK) {
                ...
                // TODO: Implement successful save logic here
    ...
    private boolean infoMatching(String email, String password) {
        boolean match = false;
        Gson gson = new Gson();
        UserInfo obj = gson.fromJson(PreferenceUtils.getUserInfo(LoginActivity.this), UserInfo.class);
