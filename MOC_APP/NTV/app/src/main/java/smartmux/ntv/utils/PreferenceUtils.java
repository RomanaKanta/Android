...
//        Log.d("SAVE JSON", "1999 "+value);
    ...
    public static void addOrderItem(Context context,String prefName, String key,
                                       String value){
        //Get previous favorite items
//        String orderList = getStringFromPreferences(context,null,"favorites");
        ...
        // Save in Shared Preferences
         saveStringPref(context,prefName,key,value);
//        return putStringInPreferences(context,favoriteList,"favorites");
    }
    public static String[] getOrderList(Context context,String prefName, String key,
                                        String value){
        String orderList = getStringPref(context,prefName,key,"");
        return convertStringToArray(orderList);
    }
