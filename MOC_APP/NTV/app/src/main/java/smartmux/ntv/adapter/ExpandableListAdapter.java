...
public class ExpandableListAdapter extends AnimatedExpandableListView.AnimatedExpandableListAdapter {
    ...
    public ExpandableListAdapter(Context context, List<MenuModel> expandableListTitle,
    ...
    public int getRealChildrenCount(int groupPosition) {
        return mExpandableListDetail.get(mExpandableListTitle.get(groupPosition))
                .size();
    }
