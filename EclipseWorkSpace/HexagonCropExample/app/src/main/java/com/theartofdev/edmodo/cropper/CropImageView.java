...
import com.example.hexagoncropexample.R;
...
public class CropImageView extends FrameLayout {
	 ...
	 * {@link #setOnGetCroppedImageCompleteListener(OnGetCroppedImageCompleteListener)}
	 * .
	 */
	 ...
	 * {@link #setImageUriAsync(Uri)}) is complete (successful or failed).
	 */
	...
	/**
	 * On complete of the async bitmap loading by {@link #setImageUriAsync(Uri)}
