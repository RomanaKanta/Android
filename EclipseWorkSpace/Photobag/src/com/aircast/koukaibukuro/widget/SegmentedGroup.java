package com.aircast.koukaibukuro.widget;
...
public class SegmentedGroup extends RadioGroup {
    ...
    public void updateBackground() {
        ...
        if (count > 1) {
            ...
            updateBackground(getChildAt(0), R.drawable.radio_checked_left_mypage, R.drawable.radio_unchecked_left_mypage);
            for (int i = 1; i < count - 1; i++) {
                updateBackground(getChildAt(i), R.drawable.radio_checked_middle_mypage, R.drawable.radio_unchecked_middle_mypage);
            ...
            updateBackground(getChildAt(count - 1), R.drawable.radio_checked_right_mypage, R.drawable.radio_unchecked_right_mypage);
        } else if (count == 1) {
            updateBackground(getChildAt(0), R.drawable.radio_checked_default_mypage, R.drawable.radio_unchecked_default_mypage);
        }
    }
