...
public class PBConstant {
    public static final String TAG = "Photobag";
    
    public static final String MANUFACTURER_AMAZON = "Amazon";
    public static final String DOWNLOAD_TAG = "DownloadTab";
    public static final String UPLOAD_TAG = "UploadTab";
    public static final String HISTORY_TAG = "HistoryTab";
    public static final String SETTINGS_TAG = "SettingTab";
    public static final String MY_PAGE_TAG = "MyPageTab";

    public static final int PB_HANDLER_DELETE_ITEM_HISTORY = 107;
    public static final int PB_HANDLER_UPDATE_DATA_HISTORY = 108;

    public static final String HISTORY_TYPE_INBOX = "inbox";
    ...
    public static final String HISTORY_ITEM_ID = "Id";
    public static final String HISTORY_COLLECTION_ID = "Collection_id";
    public static final String HISTORY_PASSWORD = "PWD";
    public static final String HISTORY_CATEGORY_INBOX = "HISTORYInbox";
    public static final String HISTORY_CREATE_DATE = "CreateDate";
    public static final String HISTORY_CHARGE_DATE = "ChargeDate";
    public static final String HISTORY_ADDIBILITY = "HistoryAddibility";
    public static final String HISTORY_IS_UPDATABLE = "HistoryIsUpdatable";
    public static final String HISTORY_UPDATED_AT = "HistoryUpdatedAt";
    public static final String HISTORY_SAVE_MARK = "HistorySaveMark";
    public static final String HISTORY_SAVE_DAYS = "HistorySaveDays";
    public static final String HISTORY_AD_LINK = "HistoryAdLink";

    public static final String COLLECTION_ID = "COLLECTION_ID";
    public static final String COLLECTION_PASSWORD = "COLLECTION_PWD";
    public static final String COLLECTION_CHARGE_AT = "COLLECTION_CHARGE_AT";
    public static final String COLLECTION_PAGE_NAME = "COLLECTION_PAGE_NAME";
    public static final String COLLECTION_THUMB = "COLLECTION_THUMB";
    
    public static final String PREF_NAME = "com.kayac.photobag";
    public static final String PREF_NAME_MARKET_URL = "photobag.url";
    public static final String PREF_NAME_UID = "uid";
    public static final String PREF_NAME_TOKEN = "token";
    public static final String PREF_NAME_EXPIRES = "expires";
    public static final String PREF_NAME_FREE_PERIOD = "free.period";
    public static final String PREF_NAME_INVITE_CODE = "invitation.code";
    public static final String PREF_SETTING_INVITED_CODE = "invited.code";
    public static final String PREF_SETTING_TWEET_STARTED = "tweet.started.photobag";
    public static final String PREF_SETTING_SHOW_NOTIFICATION = "show.notification";
    public static final String PREF_NAME_INVITATION_USERS = "invitation.users";
    public static final String PREF_NAME_BONUS = "invitation.bonus";
    public static final String PREF_SETTING_TWEET_STARTED_VIEW = "tweet.started.photobag.view";
    ...
    public static final String CACHE_FOLDER_NAME = ".photobag_cache";// 20120210 add cache folder name
    public static final String LOCAL_SEARCH_OPENBAG_DATA_FOLDER_NAME = ".photobag_search_data";

    public static final String CACHE_SHARE_FILE_NAME = "photobag";
    ...
    public static final String PREF_PASSWORD_NAME_FOR_HISTORY_BUG = "PasswordNameForHistoryBug";
    public static final String PREF_PASSWORD_PURCHASE_COMPLETE_FOR_HISTORY_BUG = "PasswordPurchaseCompleteForHistoryBug";
    ...
    public static final String INVITATION_COMPLETED = "com.kayac.photobag.invitation.success";
    ...
    //20120620 Bac purchase honey
    public static final String PREF_SIGNED_DATA = "signed_data";
    public static final String PREF_SIGNATURE = "signature";
    public static final String PHOTOBAG_MAGIC_LINK = PBAPIContant.SERVER_URL + "/p/";
    public static final String PUBLIC_PASSWORD = PBAPIContant.SERVER_IP + "2/collections/hot.html";
    public static final String PUBLIC_PASSWORD_HTTP = PBAPIContant.SERVER_URL + "/hot.html";
    ...
    public static final String APPDIRVER_IDENTIFIER = "com.kayac.photobag.indentifier.appdriver";
    public static final String APPDRIVER_REFRESH_URL = "photobagin://download";
    ...
    public static final String CHAT_GROUP_STATUS = "http://"+PBAPIContant.MAIN_DEVELOPMENT_URL+"/chat/chat_room/status";


    public static final String CHAT_SEND_GROUP_MGS = "http://"+PBAPIContant.MAIN_DEVELOPMENT_URL+"/chat/chat_message/add";



    public static final String CHAT_GROUP_MGS_LIST = "http://"+PBAPIContant.MAIN_DEVELOPMENT_URL+"/chat/chat_message/get_list";

    public static final String PREF_GROUP_EXPIRED_TIME = "expired_time";
    // TODO This URL must be changed(move to AWS server)
    //public static final String ADD_UNIMEDIA_LIST = "http://openpage.photobag.in/adstir_b.html";

    public static final String ADD_UNIMEDIA_LIST = "http://"+PBAPIContant.MAIN_DEVELOPMENT_URL+"/adstir/android/native.html";
...
//    public static final String FACEBOOK_APP_PACKAGE_NAME = "com.facebook.katana";
    ...
    public static final String PREF_FOR_PHOTO_CONTEST = "photo_contest";

    public static final String IS_DOWNLOAD_PASSWORD = "isdownload_password";

//    public static final String IS_TAG = "is_lib_tag";
...
//    public static final String IS_DOWNLOAD_TAB = "is_lib_download_tab";
	...
	public static final int MINIMUM_SIZE_ADVERTISE_DATA = 3339;
	public static final int MINIMUM_SIZE_ADVERTISE_DATA_DEVELOPMENT = 3600;
	
    public static final String PREF_INVALID_CHARACTER_EXISTS = "pref_invalid_character_exists";
    public static final String PREF_INVALID_CHARACTER = "pref_invalid_character";
    public static final String PREF_DOWNLOAD_PASSWORD_FOR_UPDATE = "download_password_for_update";
    public static final String PREF_DOWNLOAD_PURCHASE_PASSWORD = "download_purchase_password";

    public static final String PREF_PASSWORD_NOT_FROM_LIBRARY = "library_not_from_password";
    public static final String PREF_PASSWORD_FROM_LIBRARY_ANALYTICS = "library_password_analytics";

    
    // for digit
    
    public static final String PREF_FOUR_DIGIT = "four_digit";
    public static final String PREF_OPENID_SHARE_TYPE = "openid_share_type";
    public static final String PREF_OPENID_SHAREID = "openid_share_id";
    
    public static final String PREF_OPENID_MAIL = "OPENID_MAIL";
    public static final String PREF_OPENID_FACEBOOK = "OPENID_FACEBOOK";
