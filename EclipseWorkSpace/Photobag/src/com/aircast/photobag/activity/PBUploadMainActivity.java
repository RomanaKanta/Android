...
// * */
//public class PBUploadMainActivity extends PBAbsTransition {
...
//        setContentView(R.layout.pb_layout_upload_main);
//        mUploadAD = (LinearLayout) findViewById(R.id.layout_upload_ad);
//        
//        mAlbumList = new ArrayList<String>();
//        
//        mBtnDlInputUploadImg = (FButton) findViewById(R.id.btn_send_pictures);
...
//                                PBUploadMainActivity.this, true,
...
//                	          	  EasyTracker easyTracker = EasyTracker.getInstance(PBUploadMainActivity.this);
//                	          	  easyTracker.set(Fields.SCREEN_NAME, ""+deviceUUID+":PBUploadMainActivity");
...
//            					AlertDialog.Builder	networkErorrDialog =  new AlertDialog.Builder(new ContextThemeWrapper(PBUploadMainActivity.this,
//           						     R.style.popup_theme));
...
//                });
//       
//        findViewById(R.id.btn_dialog_video_compress_setting).setOnClickListener(
//                new OnClickListener() {
//                    @Override
//                    public void onClick(View v) {
//                    	// show the video compress dialog
//                		LayoutInflater inf = LayoutInflater.from( PBUploadMainActivity.this);
//                		View viewDialogVideoSetting = inf.inflate(R.layout.pb_dialog_video_setting_layout, null);
//                		dialog = new Dialog(PBUploadMainActivity.this);
...
//                        		PBUploadMainActivity.this, PBConstant.PREF_NAME, 
...
//		if (hasInternet && !PBDownloadMainActivity.isKoukaibukuroDisabled) {
//
//			System.out.println("Atik upload koukaibukuro status:"+PBDownloadMainActivity.isKoukaibukuroDisabled);
//			/*if(!PBDownloadMainActivity.isKoukaibukuroDisabled) {*/
//				webview = (WebView) findViewById(R.id.webview_upload_screen_for_kuma);
//				try {
...
//							// Go TO  webview 
//							Intent intent = new Intent(PBUploadMainActivity.this,
...
//									 }
//						
//									 String token =  PBPreferenceUtils.getStringPref(PBUploadMainActivity.this, PBConstant.PREF_NAME, 
...
//								     
//							         Intent intent = new
//									 Intent(PBUploadMainActivity.this,MainTabActivity.class);
...
//									 } else {
//						        	   
//										 /*Toast.makeText(PBUploadMainActivity.this, 
//												 getString(R.string.pb_network_not_available_general_message), 1000).show();*/
//										   Toast toast = Toast.makeText(PBUploadMainActivity.this, getString(R.string.pb_network_not_available_general_message), 
//													1000);
...
//						             } else {
//
//						              findViewById(R.id.webview_upload_screen_layout_for_kuma);
//						             }
//						             
//						             
//			        		
...
//    
//    /*
//     * Function for getting all the histories data
//     */
//    private ArrayList<HashMap<String, String>> getHistoryData() {
//    	ArrayList<HashMap<String, String>> historyItemList = new ArrayList<HashMap<String, String>>();
//		try {
...
//    				KBUploadSetPasswordActivity.class);
...
//    		startActivity(intent);
//
//    		PBTabBarActivity.sMainContext.mTabHost.setCurrentTabByTag(PBConstant.UPLOAD_TAG);
//    	}
//    }
//        
//    @Override
...
//	         }
//	         loadOpenPage(webview);
//	         findViewById(R.id.webview_upload_screen_layout_for_kuma).setVisibility(View.VISIBLE);
//	      findViewById(R.id.view_kuma_no_internet_upload).setVisibility(
//	        View.GONE);
//         
//        }
...
// 					PBGeneralUtils.showAlertDialogActionWithOnClick(PBUploadMainActivity.this, 
// 							title, 
// 							message,
...
// 		if(isFromMori) {
// 			isFromMori = false;
// 			Intent intentReward = new Intent(PBUploadMainActivity.this,
...
//	  
//	  AlertDialog.Builder exitDialog =  new AlertDialog.Builder(new ContextThemeWrapper(PBUploadMainActivity.this,
//	        R.style.popup_theme));
//	   exitDialog    .setTitle("");
