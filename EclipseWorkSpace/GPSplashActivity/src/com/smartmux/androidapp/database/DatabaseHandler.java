package com.smartmux.androidapp.database;
...
//				
//				 cursor = db.query(Constant.TABLE_TUTORIAL, new String[] {Constant.root_title,
//						 Constant.category, KEY_NAME, KEY_CONTINENT, KEY_REGION}, 
//					     null, null, null, null, null);
//		 
//		  }
//		  else {
//			  cursor = db.query(true, Constant.TABLE_TUTORIAL, new String[] {KEY_ROWID,
