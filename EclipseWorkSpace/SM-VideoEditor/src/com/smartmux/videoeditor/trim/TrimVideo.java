...
package com.smartmux.videoeditor.trim;
...
public class TrimVideo extends Activity implements MediaPlayer.OnErrorListener,
...
//				 String timeStart = "00:"+textViewLeft.getText().toString()+".0";
//					 String timeEnd = "00:"+textViewRight.getText().toString()+".0";
//						String command = "-i "+mPath+" -ss "+timeStart+" -c copy -t "+timeEnd+" "+outFilePath; 
//					 execFFmpegBinary(command);
				System.out.println(mTrimStartTime +"  "+mTrimEndTime);
			}
		});
	            ...
	            ffmpeg.execute(command, new ExecuteBinaryResponseHandler() {
	                ...
	                public void onFinish() {
	                   ...
	                   // progressDialog.dismiss();
	                    Toast.makeText(getApplicationContext(), "Trimimg Complete", Toast.LENGTH_LONG).show();
	                }
	            });
	...
	private int setProgress() {
		...
		Log.d("setTimes", mVideoPosition+ " "+duration+" "+mTrimStartTime+" "+mTrimEndTime);
