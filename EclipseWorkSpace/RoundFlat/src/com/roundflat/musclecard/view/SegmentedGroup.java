...
public class SegmentedGroup extends RadioGroup {
    ...
    public void updateBackground() {
        ...
        if (count > 1) {
            ...
            updateBackground(getChildAt(0), R.drawable.segment_checked_left, R.drawable.segment_unchecked_left);
            for (int i = 1; i < count - 1; i++) {
                updateBackground(getChildAt(i), R.drawable.segment_checked_middle, R.drawable.segment_unchecked_middle);
            ...
            updateBackground(getChildAt(count - 1), R.drawable.segment_checked_right, R.drawable.segment_unchecked_right);
        } else if (count == 1) {
            updateBackground(getChildAt(0), R.drawable.segment_checked_default, R.drawable.segment_unchecked_default);
        }
    }
