...
public class FlipAnimationEx extends Animation {
	 ...
	 */
	public FlipAnimationEx(float fromDegrees, float toDegrees, float centerX, float centerY, float scale, ScaleUpDownEnum scaleType) {
