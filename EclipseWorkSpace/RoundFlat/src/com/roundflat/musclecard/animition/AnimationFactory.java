package com.roundflat.musclecard.animition;
...
//		 Animation.RELATIVE_TO_SELF, 150.0f,Animation.RELATIVE_TO_SELF, 50.0f,
//		 Animation.RELATIVE_TO_SELF, 50.0f,Animation.RELATIVE_TO_SELF, 50.0f
//		 );
		...
		FlipAnimationEx outFlip = new FlipAnimationEx(
				dir.getStartDegreeForFirstView(),
				dir.getEndDegreeForFirstView(), centerX, centerY,
				FlipAnimationEx.SCALE_DEFAULT,
				FlipAnimationEx.ScaleUpDownEnum.SCALE_DOWN);
		...
		if (dir == FlipDirection.BOTTOM_TOP || dir == FlipDirection.TOP_BOTTOM)
			outFlip.setDirection(FlipAnimationEx.ROTATION_X);
		else
			outFlip.setDirection(FlipAnimationEx.ROTATION_Y);

		
		 Animation animation = new TranslateAnimation(0,centerX,0,centerY);
		
		AnimationSet outAnimation = new AnimationSet(true);

		outAnimation.addAnimation(outFlip);
//		outAnimation.addAnimation(inFromLeftAnimation(duration,interpolator));
//		outAnimation.setDuration(2000);
		...
		FlipAnimationEx inFlip = new FlipAnimationEx(
				dir.getStartDegreeForSecondView(),
				dir.getEndDegreeForSecondView(), centerX, centerY,
				FlipAnimationEx.SCALE_DEFAULT,
				FlipAnimationEx.ScaleUpDownEnum.SCALE_UP);
		...
		if (dir == FlipDirection.BOTTOM_TOP || dir == FlipDirection.TOP_BOTTOM)
			inFlip.setDirection(FlipAnimationEx.ROTATION_X);
		else
			inFlip.setDirection(FlipAnimationEx.ROTATION_Y);

		 Animation anim = new TranslateAnimation(centerX,0,centerY,0);
		
		AnimationSet inAnimation = new AnimationSet(true);

		inAnimation.addAnimation(inFlip);
//		inAnimation.addAnimation(inFromLeftAnimation(duration,interpolator));
