...
import com.smartmux.filevault.AppActivityManager;
import com.smartmux.filevault.LoginWindowActivity;
import com.smartmux.filevault.R;
import com.smartmux.filevault.adapter.GalleryAdapter;
import com.smartmux.filevault.modelclass.CustomGallery;
...
public class CustomGalleryActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		AppActionBar.changeActionBarFont(getApplicationContext(),CustomGalleryActivity.this);
		AppActionBar.updateAppActionBar(getActionBar(), this,true);
		getActionBar().setTitle("Image Gallery");
	...
	private void init() {
		...
		if (action.equalsIgnoreCase("ACTION_MULTIPLE_IMAGE_PICK")) {
		...
		Typeface font_style = Typeface.createFromAsset(getAssets(), AppExtra.AVENIRLSTD_LIGHT);  
		btnGalleryOk.setTypeface(font_style);
	...
	protected void onResume() {
		...
		if(event_code == AppExtra.HOME_CODE ){
			Intent i = new Intent(CustomGalleryActivity.this, LoginWindowActivity.class);
	        startActivity(i);
		}
	}
	@Override
