...
//		mAudioRecorder = savedInstanceState == null ? ApplicationClass
//				.getApplication(getApplicationContext()).createRecorder(
//						getNextFileName()) : ApplicationClass
//				.getApplication(getApplicationContext()).getRecorder();
	...
	private void pause() {
		mAudioRecorder.pause(new AudioRecorder.OnPauseListener() {
			...
			public void onPaused(String activeRecordFileName) {
				...
				mRecordStatus.setTextColor(Color.parseColor("#8E8E8E"));
			}
