...
public class TypefaceEditText extends EditText {
    ...
    /**
     * The interface to call in {@link #onKeyPreIme(int, android.view.KeyEvent)}.
    ...
    /**
     * Sets the {@link #mOnKeyCallback} that is called in {@link #onKeyPreIme(int, android.view.KeyEvent)}
     * @param onKeyCallback
     */
