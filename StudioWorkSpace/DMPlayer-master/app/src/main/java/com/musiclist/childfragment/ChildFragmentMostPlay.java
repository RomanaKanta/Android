...
import com.musiclist.adapter.AllSongsListAdapter;
    ...
    private void loadAllSongs() {
        ...
        PhoneMediaControl.setPhonemediacontrolinterface(new PhoneMediaControl.PhoneMediaControlINterface() {
            ...
            public void loadSongsComplete(ArrayList<SongDetail> songsList_) {
                songList = songsList_;
                mAllSongsListAdapter = new AllSongsListAdapter(getActivity(),songList,-1);
                recycler_songslist.setAdapter(mAllSongsListAdapter);
            }
        });
        mPhoneMediaControl.loadMusicList(getActivity(), -1, PhoneMediaControl.SonLoadFor.MostPlay, "",0);
    }
