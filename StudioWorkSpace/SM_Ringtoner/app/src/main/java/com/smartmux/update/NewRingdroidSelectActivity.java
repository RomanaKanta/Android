...
/**
 * Created by tanvir-android on 4/28/16.
 */
...
public class NewRingdroidSelectActivity
        ...
        implements LoaderManager.LoaderCallbacks<Cursor>
{
    ...
    public NewRingdroidSelectActivity() {
    }
            ...
            public void onPermissionGranted() {
                ...
                try {
                    mAdapter = new SimpleCursorAdapter(
                            NewRingdroidSelectActivity.this,
                    ...
                    getLoaderManager().initLoader(INTERNAL_CURSOR_ID,  null, NewRingdroidSelectActivity.this);
                    getLoaderManager().initLoader(EXTERNAL_CURSOR_ID,  null, NewRingdroidSelectActivity.this);
...
//                NewRingdroidEditActivity.onAbout(this);
//                return true;
...
//                return true;
    ...
    private void confirmDelete() {
        ...
        new AlertDialog.Builder(NewRingdroidSelectActivity.this)
                .setTitle(title)
                .setMessage(message)
                .setPositiveButton(
...
//        try {
            ...
            intent.setClassName( "com.smartmux.ringtoner", "com.smartmux.update.NewRingdroidEditActivity");
            startActivityForResult(intent, REQUEST_CODE_EDIT);
//        } catch (Exception e) {
//            Log.e("NewRingdroidSelect", "Couldn't start onRecord");
//        }
    }
    ...
    private void startRingdroidEditor() {
        ...
        try {
            ...
            Log.e("NewRingdroidSelect", "Couldn't start editor");
        }
    }
