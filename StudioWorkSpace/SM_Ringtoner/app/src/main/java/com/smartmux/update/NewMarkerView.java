 ...
 */
public class NewMarkerView extends ImageView {

    public interface NewMarkerListener {
        public void markerTouchStart(NewMarkerView marker, float pos);
        public void markerTouchMove(NewMarkerView marker, float pos);
    ...
    private NewMarkerListener mListener;

    public NewMarkerView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setListener(NewMarkerListener listener) {
        mListener = listener;
    }
