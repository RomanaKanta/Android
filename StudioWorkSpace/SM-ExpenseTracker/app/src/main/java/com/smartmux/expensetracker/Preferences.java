...
public class Preferences extends PreferenceActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String token = SharedPreferencesHelper.getSharedPreferences()
				.getString(getString(R.string.pref_key_token), null);
			...
			syncSetUpPref
					.setOnPreferenceClickListener(new OnPreferenceClickListener() {
						...
						public boolean onPreferenceClick(Preference preference) {
							...
							// AlertDialog.Builder(SetPreferences.this);
							// final View view =
							// getLayoutInflater().inflate(R.layout.pref_sync_dialog,
							// null);
							// builder.setView(view);
							// builder.setNegativeButton(getString(R.string.signin),
							// new OnClickListener() {
							//
							// @Override
	...
	private void uiAfterSync(Preference syncSetUpPref) {
		String name = SharedPreferencesHelper.getSharedPreferences().getString(
				getString(R.string.pref_key_sync_name), "");
		String email = SharedPreferencesHelper.getSharedPreferences()
				.getString(getString(R.string.pref_key_sync_email), "");
		syncSetUpPref.setTitle("Sync Details:");
		syncSetUpPref.setSummary(Html.fromHtml("<font color=\"#6E6E6E\">"
				+ name + "<br>" + email + "</font>"));
	}
