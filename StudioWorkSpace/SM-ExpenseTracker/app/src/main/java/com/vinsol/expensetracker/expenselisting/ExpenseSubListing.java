...
public class ExpenseSubListing extends ListingAbstract {
	...
	protected void initListView() {
		...
		listButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				//Toast.makeText(getApplicationContext(), "anim", 1000).show();
			}
		});
	...
	protected void noItemButtonAction(Button noItemButton) {
		noItemButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				finish();
				//Toast.makeText(getApplicationContext(), "Expense SubListing1", 1000).show();
			}
		});
	}
	...
	public void onBackPressed() {
		...
		//Toast.makeText(getApplicationContext(), "Expense SubListing", 1000).show();
		super.onBackPressed();
	}
