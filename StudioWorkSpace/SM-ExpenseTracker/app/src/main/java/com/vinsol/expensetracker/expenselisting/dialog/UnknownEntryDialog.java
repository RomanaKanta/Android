...
public class UnknownEntryDialog extends Dialog implements View.OnClickListener {
	...
	public UnknownEntryDialog(Entry toInsert,Context mContext, View.OnClickListener myClickListener) {
		super(mContext);
		context = mContext;
		onCreateDialog();
	...
	public UnknownEntryDialog(Context mContext,Entry _list,View.OnClickListener deleteClickListener) {
		super(mContext);
		context = mContext;
		onCreateDialog();
