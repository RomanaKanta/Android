package com.smartmux.batterymonitor.progresscircle;
...
public class ProgressIndicator extends View {
    ...
    private void parseAttributes(TypedArray a) {
        ...
        barLength = (int) a.getDimension(R.styleable.ProgressWheel_progBarLength,
                barLength);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //Draw the bar
        if (isSpinning) {
            canvas.drawArc(circleBounds, - progress, barLength, false,
                    barPaint);
        } else {
