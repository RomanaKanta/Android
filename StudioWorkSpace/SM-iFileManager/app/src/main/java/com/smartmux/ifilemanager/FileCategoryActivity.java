...
import com.smartmux.ifilemanager.R;
import com.smartmux.ifilemanager.FavoriteDatabaseHelper.FavoriteDatabaseListener;
import com.smartmux.ifilemanager.FileCategoryHelper.CategoryInfo;
import com.smartmux.ifilemanager.FileCategoryHelper.FileCategory;
import com.smartmux.ifilemanager.FileExplorerTabActivity.IBackPressedListener;
import com.smartmux.ifilemanager.FileViewInteractionHub.Mode;
import com.smartmux.ifilemanager.Util.SDCardInfo;
...
public class FileCategoryActivity extends Fragment implements
	...
	static {
		...
		// button2Category.put(R.id.category_downloads, FileCategory.Other);
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		LinearLayout allFilesContent = (LinearLayout) mRootView
				.findViewById(R.id.category_allfiles);
		allFilesContent.setOnClickListener(new OnClickListener() {
	...
	private void setupCategoryInfo() {
		...
		int[] imgs = new int[] { R.drawable.category_bar_picture,
				R.drawable.category_bar_music, R.drawable.category_bar_video,
				R.drawable.category_bar_theme, R.drawable.category_bar_zip,
	  ...
	  public void refreshCategoryInfo() {
	        ...
	        if (sdCardInfo != null) {
	            ...
	            long size = sdCardInfo.total - sdCardInfo.free;
	            setTextView(R.id.category_all_size, Util.convertStorage(size));
	        }
	       ...
	       // setTextView(R.id.category_legend_fav, Util.convertStorage(size));
	...
	private void showPage(ViewPage p) {
		...
		//showView(R.id.adstir_space, false);
		...
		case Home:
			...
			if (mConfigurationChanged) {
				((FileExplorerTabActivity) mActivity)
						.reInstantiateCategoryTab();
				mConfigurationChanged = false;
			}
			break;
		case Favorite:
			//showView(R.id.adstir_space, true);
	...
	private void setCategoryCount(FileCategory fc, long count) {
		...
		switch (id) {
		case R.id.category_music_count:
			setTextView(id, getString(R.string.category_music) + "(" + count
					+ ")");
			break;
		case R.id.category_video_count:
			setTextView(id, getString(R.string.category_video) + "(" + count
					+ ")");
			break;
		case R.id.category_picture_count:
			setTextView(id, getString(R.string.category_picture) + "(" + count
					+ ")");
			break;
		case R.id.category_theme_count:
			setTextView(id, getString(R.string.category_theme) + "(" + count
					+ ")");
			break;
		case R.id.category_document_count:
			setTextView(id, getString(R.string.category_document) + "(" + count
					+ ")");
			break;
		case R.id.category_zip_count:
			setTextView(id, getString(R.string.category_zip) + "(" + count
					+ ")");
			break;
		case R.id.category_apk_count:
			setTextView(id, getString(R.string.category_apk) + "(" + count
					+ ")");
			break;
		case R.id.category_favorite_count:
			setTextView(id, getString(R.string.category_favorite) + "(" + count
					+ ")");
			break;
		// case Other:
		// return R.id.category_downloads_count;
		}
	...
	private void setupClick() {
		...
		// setupClick(R.id.category_downloads);
	}
	...
	private void setCategorySize(FileCategory fc, long size) {
		...
		case Favorite:
			txtId = R.id.category_legend_fav;
			resId = R.string.category_favorite;
			break;
		// case Other:
	...
	private void setCategoryBarValue(FileCategory f, long size) {
		if (mCategoryBar == null) {
			mCategoryBar = (CategoryBar) mRootView
