...
//                R.drawable.toolbar_top));
        mTabsAdapter = new TabsAdapter(this, mViewPager);
        mTabsAdapter.addTab(bar.newTab().setText(R.string.tab_category),
                FileCategoryActivity.class, null);
        mTabsAdapter.addTab(bar.newTab().setText(R.string.tab_allfiles),
                FileViewActivity.class, null);
        mTabsAdapter.addTab(bar.newTab().setText(R.string.tab_wifi),
...
//                .getInt(INSTANCESTATE_TAB, Util.CATEGORY_TAB_INDEX));
    ...
    public static class TabsAdapter extends FragmentPagerAdapter
        ...
        public void onTabSelected(Tab tab, FragmentTransaction ft) {
            ...
            if(!tab.getText().equals(mContext.getString(R.string.tab_allfiles))) {
