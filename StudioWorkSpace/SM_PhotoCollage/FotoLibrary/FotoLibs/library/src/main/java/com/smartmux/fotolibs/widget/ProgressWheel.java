...
public class ProgressWheel extends View {
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius = (int) a.getDimension(R.styleable.ProgressWheelLib_circleRadiusLib, circleRadius);

        fillRadius = a.getBoolean(R.styleable.ProgressWheelLib_fillRadiusLib, false);

        barWidth = (int) a.getDimension(R.styleable.ProgressWheelLib_barWidthLib, barWidth);

        rimWidth = (int) a.getDimension(R.styleable.ProgressWheelLib_rimWidthLib, rimWidth);

        float baseSpinSpeed = a.getFloat(R.styleable.ProgressWheelLib_spinSpeedLib, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime = a.getInt(R.styleable.ProgressWheelLib_barSpinCycleTimeLib, (int) barSpinCycleTime);

        barColor = a.getColor(R.styleable.ProgressWheelLib_barColorLib, barColor);

        rimColor = a.getColor(R.styleable.ProgressWheelLib_rimColorLib, rimColor);

        linearProgress = a.getBoolean(R.styleable.ProgressWheelLib_linearProgressLib, false);

        if (a.getBoolean(R.styleable.ProgressWheelLib_progressIndeterminateLib, false)) {
            spin();
        }
