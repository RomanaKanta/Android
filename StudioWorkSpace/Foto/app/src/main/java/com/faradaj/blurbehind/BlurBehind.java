...
@SuppressLint("NewApi") public class BlurBehind {
    ...
    private static final android.util.LruCache<String, Bitmap> mImageCache = new android.util.LruCache<String, Bitmap>(1);
