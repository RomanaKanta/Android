...
import com.smartmux.foto.widget.DrawCircle;
import com.smartmux.foto.widget.SimpleDrawingView;
public class FragmentDraw extends Fragment implements OnClickListener {
	...
	private void setDrawFunction(View rootView) {
		...
		colorPicker = (SeekBar) rootView.findViewById(R.id.colorPickerSeekBar);
		...
		strokeSeekBar.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
			...
			public void onProgressChanged(SeekBar seekBar, int progress,
				...
				circle.setRadius((int) (progress * 1.3));
				circle.invalidate();
				drawingView.setStroke((int) (progress * 2));
			}
		});
		...
		// .setOnColorSeekbarChangeListener(new OnColorSeekBarChangeListener() {
		//
		// @Override
		// public void onStopTrackingTouch(SeekBar seekBar) {
		// }
		...
		//
		// @Override
		// public void onColorChanged(SeekBar seekBar, int color,
		// boolean b) {
		// // Log.d("color", "" + color);
		// prevcolor = color;
		// if (drawingView.isErase == false && isErase == false) {
