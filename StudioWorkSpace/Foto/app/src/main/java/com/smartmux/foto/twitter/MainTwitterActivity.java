//package com.smartmux.foto.twitter;
//
...
//
//public class MainTwitterActivity extends Activity implements OnClickListener {
//
...
//		findViewById(R.id.button_tw_cancel).setOnClickListener(this);
//
...
//				loginLayout.setVisibility(View.GONE);
//				shareLayout.setVisibility(View.VISIBLE);
//				userName.setText(MainTwitterActivity.this.getResources()
...
//			super.onPreExecute();
//
//			pDialog = new ProgressDialog(MainTwitterActivity.this);
...
//				// Log.d("Path", "" + BitmapHolder.getPath());
...
//			pDialog.dismiss();
//
//			Toast.makeText(MainTwitterActivity.this, "Posted to Twitter!",
//					Toast.LENGTH_SHORT).show();
//
