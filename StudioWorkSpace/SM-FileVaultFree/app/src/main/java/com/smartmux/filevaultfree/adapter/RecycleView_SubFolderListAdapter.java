...
import com.smartmux.filevaultfree.adapter.RecycleView_SubFolderListAdapter.SubFolderViewHolder;
import com.smartmux.filevaultfree.modelclass.SubFolderItemRow;

public class RecycleView_SubFolderListAdapter extends
RecyclerView.Adapter<SubFolderViewHolder> {// Recyclerview will
	// extend to
