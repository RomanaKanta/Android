...
//import com.smartmux.filevaultfree.AppClass;
...
//                ? AppClass.getApplication(getActivity()).createRecorder(getNextFileName())
//                : AppClass.getApplication(getActivity()).getRecorder();
//
