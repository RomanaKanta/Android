...
package com.smartmux.musiclist.slidinguppanelhelper;
...
public class ViewDragHelper {
	 ...
	 * callback's {@link com.smartmux.musiclist.slidinguppanelhelper.ViewDragHelper.Callback#onEdgeTouched(int, int)} and
	 * {@link com.smartmux.musiclist.slidinguppanelhelper.ViewDragHelper.Callback#onEdgeDragStarted(int, int)} methods will only be invoked
	 ...
	 * {@link com.smartmux.musiclist.slidinguppanelhelper.ViewDragHelper.Callback#tryCaptureView(android.view.View, int)} will not be asked
	 ...
	 * {@link com.smartmux.musiclist.slidinguppanelhelper.ViewDragHelper.Callback#getOrderedChildIndex(int)}.
	 *
	 * @param x
	 *            X position to test in the parent's coordinate system
	 * @param y
