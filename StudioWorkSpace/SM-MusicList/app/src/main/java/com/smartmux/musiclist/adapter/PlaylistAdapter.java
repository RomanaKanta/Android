...
public class PlaylistAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		 ...
		 if (convertView == null) {
             ...
             holder.icon = (RelativeLayout) convertView.findViewById(R.id.playlist_icon);
             holder.iconChar = (TextView) convertView.findViewById(R.id.playlist_Letter);
        ...
        GradientDrawable drawable = (GradientDrawable) holder.icon
                .getBackground();
        drawable.setColor(primColor);

//        String test = playlist.get(position).getName();
//        char first = test.charAt(0);

        holder.iconChar.setText(""+playlist.get(position).getName().charAt(0));
                        ...
                        public boolean onMenuItemClick(MenuItem item) {
                            ...
                            switch (item.getItemId()) {
                                case R.id.playlist_rename:
                                    playlistRename(playlist.get(position).getId(),playlist.get(position).getName());
                                    break;
    ...
    public void playlistRename(final long playlist_id, String title){
            ...
            alertDialogBuilder.setPositiveButton(R.string.done,
                    new DialogInterface.OnClickListener() {
                        public void onClick(final DialogInterface dialog, int id) {
                            ...
                            Playlist.deletePlaylist(mContext.getContentResolver(), playlist.get(position).getId());
