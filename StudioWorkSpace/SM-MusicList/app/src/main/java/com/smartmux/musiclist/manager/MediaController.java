...
import com.smartmux.musiclist.ApplicationDMPlayer;
import com.smartmux.musiclist.dbhandler.FavoritePlayTableHelper;
import com.smartmux.musiclist.dbhandler.MostAndRecentPlayTableHelper;
...
public class MediaController implements NotificationManager.NotificationCenterDelegate, SensorEventListener {
    ...
    public void repeatSong(final boolean loop){

       this.repeat = loop;
    }

    public void shufflSong(final boolean shuffl){

        this.shuffleMusic = shuffl;
    }
