...
import com.smartmux.musiclist.observablelib.ObservableScrollView;
import com.smartmux.musiclist.observablelib.ObservableScrollViewCallbacks;
import com.smartmux.musiclist.observablelib.ScrollState;
import com.smartmux.musiclist.observablelib.ScrollUtils;
...
import com.smartmux.musiclist.uicomponent.ExpandableHeightListView;
...
public class AlbumAndArtisDetailsActivity extends ActionBarActivity implements View.OnClickListener, ObservableScrollViewCallbacks, Slider.OnValueChangedListener,
    ...
    private void loadAlbumSongs(long id) {
        ...
        mPhoneMediaControl.loadMusicList(context, id, PhoneMediaControl.SonLoadFor.Album, "",0);
    ...
    private void loadArtisSongs(long id) {
        ...
        mPhoneMediaControl.loadMusicList(context, id, PhoneMediaControl.SonLoadFor.Artis, "",0);
    }
    ...
    private void loadGenersSongs(long id) {
        ...
        mPhoneMediaControl.loadMusicList(context, id, PhoneMediaControl.SonLoadFor.Gener, "",0);
    }
