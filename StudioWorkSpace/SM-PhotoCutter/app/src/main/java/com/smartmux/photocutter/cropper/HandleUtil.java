...
class HandleUtil {
    ...
    public static Handle getPressedHandle(float x,
        ...
        if (cropShape == CropImageView.CropShape.RECTANGLE
                || cropShape == CropImageView.CropShape.DIAMOND
                || cropShape == CropImageView.CropShape.PENTAGON
                || cropShape == CropImageView.CropShape.HEXAGON
                || cropShape == CropImageView.CropShape.OCTAGON) {
            pressedHandle = getRectanglePressedHandle(x, y, left, top, right, bottom, targetRadius);
        }
//        else if (cropShape == CropImageView.CropShape.HEXAGON) {
//            pressedHandle = getHexagonPressedHandle(x, y, left, top, right, bottom, targetRadius);
//        }
