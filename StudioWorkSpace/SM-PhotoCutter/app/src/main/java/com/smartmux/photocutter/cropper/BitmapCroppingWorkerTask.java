 ...
 */
class BitmapCroppingWorkerTask extends AsyncTask<Void, Void, BitmapCroppingWorkerTask.Result> {
    ...
    protected Result doInBackground(Void... params) {
        try {
            if (!isCancelled()) {
                ...
                if (bitmap != null && mCropShape == CropImageView.CropShape.HEXAGON) {
                    bitmap = BitmapUtil.getHexaShapeCroppedBitmap(bitmap);
                }
                else  if (bitmap != null && mCropShape == CropImageView.CropShape.PENTAGON) {
                    bitmap = BitmapUtil.getPentagonShapeCroppedBitmap(bitmap);
                }
                else  if (bitmap != null && mCropShape == CropImageView.CropShape.DIAMOND) {
                    bitmap = BitmapUtil.getDiamondShapeCroppedBitmap(bitmap);
                }
                else  if (bitmap != null && mCropShape == CropImageView.CropShape.OCTAGON) {
                    bitmap = BitmapUtil.getOctaShapeCroppedBitmap(bitmap);
                }
                else if (bitmap != null && mCropShape == CropImageView.CropShape.OVAL) {
