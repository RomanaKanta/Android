...
class BitmapUtil {
    ...
    public static  Bitmap getPentagonShapeCroppedBitmap(Bitmap bitmap) {
        ...
        int x2 =0;
        int y2 =  finalBitmap.getHeight()/3;

        int x3 = finalBitmap.getWidth()/5;
        int y3 =  finalBitmap.getHeight();

        int x4 = finalBitmap.getWidth()-x3;
        int y4 = finalBitmap.getHeight();

        int x5 = finalBitmap.getWidth();
        int y5 =  finalBitmap.getHeight()/3;
    ...
    public static  Bitmap getHexaShapeCroppedBitmap(Bitmap bitmap) {
        Bitmap finalBitmap =bitmap ;
        Bitmap output = Bitmap.createBitmap(finalBitmap.getWidth(),
                finalBitmap.getHeight(), Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(output);
    ...
    public static  Bitmap getOctaShapeCroppedBitmap(Bitmap bitmap) {
        Bitmap finalBitmap =bitmap ;
        Bitmap output = Bitmap.createBitmap(finalBitmap.getWidth(),
                finalBitmap.getHeight(), Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(output);
        ...
        int x4 = finalBitmap.getWidth()/4;
        int y4 =  finalBitmap.getHeight();

        int x5 = finalBitmap.getWidth()-x4;
        int y5 =  finalBitmap.getHeight();

        int x7 = finalBitmap.getWidth();
        int y7 = finalBitmap.getHeight()/4;

        int x6 = finalBitmap.getWidth();
        int y6 =  finalBitmap.getHeight()-y7;


        int x8 = finalBitmap.getWidth()-x1;
        int y8 =  0;
    ...
    public static  Bitmap getDiamondShapeCroppedBitmap(Bitmap bitmap) {
        Bitmap finalBitmap =bitmap ;
        Bitmap output = Bitmap.createBitmap(finalBitmap.getWidth(),
                finalBitmap.getHeight(), Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(output);
        ...
        int x2 =0;
        int y2 =  finalBitmap.getHeight()/5;
        ...
        int x6 = finalBitmap.getWidth();
        int y6 = finalBitmap.getHeight()/5;

        int x5 = finalBitmap.getWidth();
        int y5 =  y6+y6;

        int x7 = finalBitmap.getWidth()-x1;
        int y7 =  0;
     ...
     * Helper that does the work of the above functions. Gets the rectangular
     * position of a Bitmap if it were placed inside a View with scale type set
     * to {@link android.widget.ImageView.ScaleType#FIT_CENTER}.
     *
     * @param bitmapWidth the Bitmap's width
     * @param bitmapHeight the Bitmap's height
     * @param viewWidth the parent View's width
