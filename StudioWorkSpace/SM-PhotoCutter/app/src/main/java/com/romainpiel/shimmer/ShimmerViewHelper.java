...
public class ShimmerViewHelper {
    ...
    public ShimmerViewHelper(Context context,View view, Paint paint, AttributeSet attributeSet) {
        this.view = view;
        this.paint = paint;
//        this.paint.setTypeface(Typeface.createFromAsset(context.
//				getAssets(), "fonts/" + "HelveticaNeue-Bold.ttf"));
        init(attributeSet);
    }
    ...
    public void onDraw() {
        ...
        if (isShimmering) {
            ...
            linearGradientMatrix.setTranslate((float) (1.5 * gradientX), 0);
