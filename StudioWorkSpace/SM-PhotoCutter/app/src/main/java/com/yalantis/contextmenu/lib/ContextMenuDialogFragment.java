...
public class ContextMenuDialogFragment extends DialogFragment implements
	...
	public void onAttach(Activity activity) {
		...
		try {
			...
			Log.e(TAG,
					activity.getClass().getSimpleName() + " should implement "
							+ OnMenuItemClickListener.class.getSimpleName());
		}
		try {
			...
			Log.e(TAG,
					activity.getClass().getSimpleName() + " should implement "
							+ OnMenuItemLongClickListener.class.getSimpleName());
		}
	}
...
//				WindowManager.LayoutParams.FLAG_DIM_BEHIND);
	...
	public void onLongClick(View v) {
		if (mItemLongClickListener != null) {
			mItemLongClickListener.onMenuItemLongClick(v,
					mWrapperButtons.indexOfChild(v));
		}
		close();
	}
