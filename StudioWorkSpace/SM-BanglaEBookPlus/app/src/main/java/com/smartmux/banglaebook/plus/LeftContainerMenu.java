package com.smartmux.banglaebook.plus;//package com.smartmux.banglaebook.plus;
//
...
// */
//public class LeftContainerMenu extends HorizontalScrollView {
//    public LeftContainerMenu(Context context, AttributeSet attrs, int defStyle) {
//        super(context, attrs, defStyle);
//        init(context);
//    }
//
//    public LeftContainerMenu(Context context, AttributeSet attrs) {
//        super(context, attrs);
//        init(context);
//    }
//
//    public LeftContainerMenu(Context context) {
//        super(context);
//        init(context);
//    }
//
...
//
//            final HorizontalScrollView me = LeftContainerMenu.this;
//
