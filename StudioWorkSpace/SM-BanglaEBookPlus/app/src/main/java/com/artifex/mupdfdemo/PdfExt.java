...
//import com.smartmux.publisherapp.bhashachitra.R;
//import com.smartmux.publisherapp.bhashachitra.adapter.PdfThumbsAdapter;
//import com.smartmux.widget.HorizoantalListView;
...
//	private HorizoantalListView thumbListView;
//
...
//
//			
//			String banglaTitle = getIntent().getExtras().getString("title");
...
//
//		
//		 thumbListView = (HorizoantalListView) findViewById(R.id.hlvSimpleList);
//		thumbListView.setAdapter(new PdfThumbsAdapter(MuPDFActivity.this,core));
//		thumbListView.setOnItemClickListener(new OnItemClickListener() {
//
//			@Override
...
//		
//		this.findViewById(R.id.button_thumb).setOnClickListener(new OnClickListener() {
//			
//			@Override
//			public void onClick(View v) {
//				// TODO Auto-generated method stub
...
//		});
//		
//		ToggleButton btnBookMode = (ToggleButton) findViewById(R.id.toggleButton_book_mode);
//		
//		btnBookMode.setOnCheckedChangeListener(new OnCheckedChangeListener() {
//			
//			@Override
...
//				}
//			});
//			thumbListView.startAnimation(anim);
//
...
////				.findViewById(android.R.id.search_close_btn);
...
////		}
//		this.findViewById(R.id.book_thumbcontent).setVisibility(View.VISIBLE);
//		GridView grid = (GridView) 
//				findViewById(R.id.gridView_thumb);
...
//				findViewById(R.id.book_thumbcontent).setVisibility(View.GONE);
//			}
//		});
//	}
//
